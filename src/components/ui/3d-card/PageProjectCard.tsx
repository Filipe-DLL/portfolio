...
export default function ProjectCard({ props }: projectDataType) {
  return (
    <CardContainer className="inter-var">
      <CardBody className="relative flex flex-col justify-between group/card hover:shadow-2xl hover:shadow-emerald-500/[0.1] bg-BgBlur border-white/[0.2] w-[400px] sm:w-[900px] h-full rounded-xl p-6 border">
        <CardItem
          translateZ="30"
        ...
        <CardItem
          as="p"
          translateZ="40"
          className="text-sm h-24 mt-2text-neutral-300"
        >
          {props.description}
        ...
        <CardItem translateZ="60" className="w-full mt-4">
          <Image
            ...
            height="1000"
            width="1000"
            className="h-60 lg:h-96 w-full self-center object-cover rounded-xl group-hover/card:shadow-xl"
          />
        </CardItem>
        <CardItem
          as="div"
