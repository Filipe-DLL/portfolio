...
export default function Tecnologias() {
  return (
    <section id="Tecnologias" className="animate__fadeIn animate__animated relative py-20 h-full w-full overflow-hidden">

      <div className="h-[500px] w-full flex flex-col items-center justify-center overflow-hidden">

        <Image src={bgImageSecundaria} className="h-[500px] fixed bg-fixed -z-40"
          alt="background"
          quality={100}
          style={{
            objectFit: 'cover',
        ...
        <div className="h-[500px] bg-BgBlur w-full  flex flex-col items-center justify-center">
